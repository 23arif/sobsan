                ...
                <div class="header-wrapper">
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-block signup d-none d-lg-flex">
                            <a class="block-link" href="login"><img src="{{asset('sobsan/img/icon/icons-login.svg')}}" alt="favorite">Giriş</a>
                ...
                <div class="header-wrapper">
                    ...
                    <div class="right">
                        ...
                        <div class="header-block signup">
                            <a class="block-link" href="signin.html"><img src="{{asset('sobsan/img/icon/icons-login.svg')}}" alt="favorite">Giriş</a>
