                ...
                <div class="col-sm-12">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h3 class="panel-title">Slider <a href="{{asset('slider_add')}}"> Əlavə et</a></h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <table id="table-1" class="table table-bordered table-striped">
                                ...
                                @foreach($sliders as $slider)
                                    ...
                                    <tr>
                                        <td>
                                            <img style="width:100px;" src="{{asset('public/slider/'.$slider->img)}}">
                                        </td>
                                        <td>
                                                {{ $slider->getSlider->first()->title }}
                                        </td>
                                        <td><a href="{{asset('slider_delete/'.$slider->id)}}"
                                               style="margin-left:30px; color:red;">Sil</a>
                                        <a href="{{asset('slider_edit/'.$slider->id)}}"
