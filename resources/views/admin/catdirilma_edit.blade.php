                        ...
                        <div class="col-sm-9 col-md-10">
                            ...
                            <div class="compose-container">
                                ...
                                <form class="form-horizontal" role="form"
                                    ...
                                    <input type="hidden" name="type" value="catdirilma">
                                    ...
                                    <div class="form-group">
                                        @if($article->where('type','catdirilma')->first()->img)
                                            <img src="{{asset('/public/article/'.$article->where('type','catdirilma')->first()->img)}}" width="200" height="150">
                                        @endif
