                        ...
                        <div class="col-sm-9 col-md-10">
                            ...
                            <div class="compose-container">
                                ...
                                <form class="form-horizontal" role="form"
                                      action="{!! URL::action('SliderController@store') !!}" method="POST"
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade active in" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-1 control-label">Button adı (Az)</label>
                                                <div class="col-sm-11">
                                        ...
                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-1 control-label">Button adı (En)</label>
                                                <div class="col-sm-11">
                                                    <input type="text" name="button[]" value="{!! old('button') !!}"
                                                           class="form-control">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-1 control-label">Button adı (Ru)</label>
                                                <div class="col-sm-11">
                                                    <input type="text" name="button[]" value="{!! old('button') !!}"
                                                           class="form-control">
                                                </div>
