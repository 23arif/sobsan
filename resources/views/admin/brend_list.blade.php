                        ...
                        <div class="panel-body content-title-container">
                            <div class="right">
                                <ol class="breadcrumb breadcrumb-theme breadcrumb-sm breadcrumb-blue">
                                    <li class="active"><a>Brendlər</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h3 class="panel-title">Brendlər <a href="{{asset('brend_add')}}"> Əlavə et</a></h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <table id="table-1" class="table table-bordered table-striped">
                                ...
                                @foreach($brends as $brend)
                                    ...
                                    <tr>
                                        <td>
                                            <img style="width:100px;" src="{{asset('public/brend/'.$brend->img)}}">
                                        </td>
                                        <td>
                                            {{ $brend->name }}
                                        </td>
                                        <td><a href="{{asset('brend_delete/'.$brend->id)}}"
                                               style="margin-left:30px; color:red;">Sil</a>
                                            <a href="{{asset('brend_edit/'.$brend->id)}}"
